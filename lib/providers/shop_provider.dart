...
class ShopProvider extends ChangeNotifier {
  static const _coinsKey = 'ff_coins';
  static const _ownedKey = 'ff_owned_items';
  static const _activeThemeKey = 'ff_active_theme';
  static const _activeBgKey = 'ff_active_background';
  static const _activeSkinKey = 'ff_active_skin';
  static const _lastDailyKey = 'ff_last_daily_reward';
  static const _focusRewardDateKey = 'ff_focus_reward_date';
  static const _focusRewardCountKey = 'ff_focus_reward_count';
  static const _streakRewardDateKey = 'ff_streak_reward_date';
  static const _streakRewardCountKey = 'ff_streak_reward_count';
  static const _processedPurchasesKey = 'ff_processed_purchases';
  ...
  bool get hasCustomTimer => _ownedItems.contains('feat_custom_timer');
  bool get hasLongBreak => _ownedItems.contains('feat_long_break');
  bool get hasWhiteNoise => _ownedItems.contains('feat_white_noise');
  bool get hasStatsExport => _ownedItems.contains('feat_stats_export');
  ...
  TreeStyle get activeTreeStyle => TreeStyle.get(_activeSkinId);
  ...
  Future<bool> rewardForFocusSession() => _dailyReward(
        dateKey: _focusRewardDateKey,
        countKey: _focusRewardCountKey,
        max: IapConstants.maxFocusRewardsPerDay,
        amount: IapConstants.focusSessionReward,
        messageKey: 'focusSessionRewardEarned',
      );

  Future<bool> rewardForStreakBonus() => _dailyReward(
        dateKey: _streakRewardDateKey,
        countKey: _streakRewardCountKey,
        max: IapConstants.maxStreakBonusPerDay,
        amount: IapConstants.streakBonusReward,
        messageKey: 'streakBonusEarned',
      );
